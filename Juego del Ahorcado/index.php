...
// ALl the body parts
$bodyParts = ["1","2","3","4","5","6","7","8"];


// Random words for the game and you to guess
$words = [
   "FIERRO", "CAMISA" , "LITERA", "HERNIA", "PEINES",
    "CASUAL", "FUCSIA"
];


function getCurrentPicture($part){
    return "./images/parte.". $part. ".png";
}
...
<ellipse fill="#EF3D23" cx="61.128" cy="19.872" rx="49.25" ry="8.916"/>
        ...
        <h1 class="titulo"> JUEGO EL AHORCADO</h1>
    </div>
        ...
        <div class="main">
         ...
         <!-- TITULO nivel -->
         <h1 class="nivel">LEVEL 1
         <p>Este nivel contiene palabras 6 letras</p>
         </h1>
        ...
        <div class="main2">
                ...
                for($j=0; $j<= $maxLetters; $j++): $l = getCurrentWord()[$j]; ?>
                    <?php if(in_array($l, getCurrentResponses())):?>
                        <span class="espacios"><?php echo $l;?></span>
                    <?php else: ?>
            ...
            <div style="display: inline-block; background: #fff; margin-left: 100px; border-radius: 5px;">
                 <img class="people" src="<?php echo getCurrentPicture(getCurrentPart());?>"/>
            ...
            <div class="texto">
                ...
                <div style="display:inline-block;">
                    ...
                    <?php
                        ...
                        for($i=0; $i<= $max; $i++){
                            echo "<button class='boton-letras' type='submit' name='kp' value='". $letters[$i] . "'>".
                            $letters[$i] . "</button>";
                            if ($i % 5 == 0 && $i>0) {
                               echo '<br>';
                            }
                    ...
                    <br><br> 
                    <!-- Restart game button -->
                    <button type="submit" name="start" class="restaurar">Restart Game</button>
                       <!-- #region
                    <br>
                    <button type="submit" name="start" class="next" href="level2.php">Next Level</button> -->
                    <br><br> <br>
                    <a href="level2.php" class="next"  type="submit" name="start" > NEXT LEVEL </a>
                    </form>
                </div>
            </div>
   ...
   <!-- #region -->
        <div class="footer">
            <p>Todos los derechos reservados a <a href="https://github.com/PaulinaMales" target="_blank">Paulina Males, Marcos Moreira</a> y su equipo.</p>
        <p class="small">© 2022 Paulina Males y Marcos Moreira. All Rights Reserved.</p>
        </div>
