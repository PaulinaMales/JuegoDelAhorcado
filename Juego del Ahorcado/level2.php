...
$words = [
   "AMBIENTES", "BACTERIAS" , "ABERTURAS", "ARMADILLO", "MARIPOSA",
    "LANGOSTA", "AMARILLO"
];
...
<ellipse fill="#EF3D23" cx="61.128" cy="19.872" rx="49.25" ry="8.916"/>
        ...
        <div class="main">
          ...
          <!-- TITULO nivel -->
          <h1 class="nivel">LEVEL 2
         <p>Este nivel contiene palabras 9 letras</p>
         </h1>
        ...
        <div class="main2">
            ...
            <div class="texto">
                ...
                <div style="display:inline-block;">
                    ...
                    <br>
                 <!-- #region 
                    <button type="submit" name="start" class="next">Next Level</button>-->
                    </form>
                </div>
            </div>
